...
static bool LoopSameIterationsCheck(NaturalLoop *L1, NaturalLoop *L2) { return false; }
...
static bool LoopAntiDependencyCheck(NaturalLoop *L1, NaturalLoop *L2) { return false; }
