...
L5:  ;  preheader0
    ...
    br label %L6
L6:  ;  exiting0  header0
    %r54 = phi i32 [%r17,%L5],[%r35,%L12]
    %r51 = phi i32 [%r17,%L5],[%r50,%L12]
    %r48 = phi i32 [1,%L5],[%r42,%L12]
    %r26 = icmp slt i32 %r48,%r1
    br i1 %r26, label %L7, label %L8
L7:  ;
    %r29 = icmp slt i32 %r54,0
...
L9:  ;
    br label %L10
L10:  ;
    %r53 = phi i32 [%r54,%L7],[0,%L9]
    %r33 = getelementptr i32, ptr %r0, i32 %r48
    %r34 = load i32, ptr %r33
    %r35 = add i32 %r53,%r34
    %r38 = icmp slt i32 %r51,%r35
    br i1 %r38, label %L11, label %L12
L11:  ;
    br label %L12
L12:  ;  latch0
    %r50 = phi i32 [%r51,%L10],[%r35,%L11]
    %r42 = add i32 %r48,1
    br label %L6
L13:  ;
    %r46 = phi i32 [0,%L2],[%r12,%L4],[%r51,%L8]
    ret i32 %r46
}
define i32 @main()
{
