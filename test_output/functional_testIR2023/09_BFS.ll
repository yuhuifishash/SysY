...
L10:
    %r46 = load i32, ptr %r22
    %r47 = add i32 0,1
    %r48 = sub i32 0,%r47
    %r49 = icmp ne i32 %r46,%r48
...
L15:
    %r64 = add i32 0,0
    %r65 = load i32, ptr %r57
    %r66 = getelementptr [1005 x i32], ptr @que, i32 0, i32 %r65
    %r67 = load i32, ptr %r66
    %r68 = getelementptr [1005 x i32], ptr @inq, i32 0, i32 %r67
    store i32 %r64, ptr %r68
    %r69 = load i32, ptr %r57
    %r70 = add i32 0,1
    %r71 = add i32 %r69,%r70
    store i32 %r71, ptr %r57
    br label %L16
L16:
    %r72 = load i32, ptr %r57
    %r73 = load i32, ptr @tail
    %r74 = icmp sle i32 %r72,%r73
