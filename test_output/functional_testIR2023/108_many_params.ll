...
L3:  ;
    ...
    %r105 = add i32 0,0
    store i32 %r70, ptr %r32
    store i32 %r75, ptr %r33
    store i32 %r76, ptr %r34
    store i32 %r77, ptr %r35
    store i32 %r78, ptr %r36
    store i32 %r79, ptr %r37
    store i32 %r80, ptr %r38
    store i32 %r81, ptr %r39
    store i32 %r82, ptr %r40
    store i32 %r83, ptr %r41
    store i32 %r84, ptr %r42
    store i32 %r85, ptr %r43
    store i32 %r86, ptr %r44
    store i32 %r87, ptr %r45
    store i32 %r88, ptr %r46
    store i32 %r89, ptr %r47
    store i32 %r90, ptr %r48
    store i32 %r91, ptr %r49
    store i32 %r92, ptr %r50
    store i32 %r93, ptr %r51
    store i32 %r94, ptr %r52
    store i32 %r95, ptr %r53
    store i32 %r96, ptr %r54
    store i32 %r97, ptr %r55
    store i32 %r98, ptr %r56
    store i32 %r99, ptr %r57
    store i32 %r100, ptr %r58
    store i32 %r101, ptr %r59
    store i32 %r102, ptr %r60
    store i32 %r103, ptr %r61
    store i32 %r104, ptr %r62
    store i32 %r105, ptr %r63
    br label %L1
}
