...
L4:
    %r108 = load i32, ptr %r3
    %r109 = load i32, ptr %r0
    %r110 = icmp sle i32 %r108,%r109
...
L5:
    ...
    %r117 = getelementptr [10 x [10 x i32]], ptr @dp, i32 0, i32 %r113, i32 %r116
