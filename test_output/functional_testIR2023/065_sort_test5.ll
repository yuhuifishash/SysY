...
L3:  ;
    ...
    %r20 = load i32, ptr %r3
    %r21 = load i32, ptr %r5
    %r22 = call i32 @heap_ajust(ptr %r0,i32 %r20,i32 %r21)
...
L6:  ;
    ...
    %r37 = load i32, ptr %r3
    %r38 = call i32 @swap(ptr %r0,i32 %r36,i32 %r37)
    ...
    %r44 = load i32, ptr %r5
    %r45 = call i32 @heap_ajust(ptr %r0,i32 %r43,i32 %r44)
...
L9:  ;
    %r44 = load i32, ptr %r5
    %r45 = load i32, ptr %r8
    %r46 = call i32 @swap(ptr %r0,i32 %r44,i32 %r45)
