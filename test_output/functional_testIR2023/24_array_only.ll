...
L3:  ;
    ...
    %r22 = add i32 1,0
    %r23 = sub i32 %r21,%r22
    call void @inc_impl(ptr %r0,i32 %r23)
    br label %L4
L4:  ;
    ret void
}
...
L1:  ;
    ...
    %r4 = load i32, ptr %r3
    call void @inc_impl(ptr %r0,i32 %r4)
    ret void
}
...
L3:  ;
    ...
    %r26 = add i32 1,0
    %r27 = sub i32 %r25,%r26
    call void @add_impl(ptr %r0,ptr %r1,i32 %r27)
    br label %L4
L4:  ;
    ret void
}
...
L1:  ;
    ...
    %r6 = load i32, ptr %r5
    call void @add_impl(ptr %r0,ptr %r1,i32 %r6)
    ret void
}
...
L3:  ;
    ...
    %r26 = add i32 1,0
    %r27 = sub i32 %r25,%r26
    call void @sub_impl(ptr %r0,ptr %r1,i32 %r27)
    br label %L4
L4:  ;
    ret void
}
...
L1:  ;
    ...
    %r5 = getelementptr [1 x i32], ptr @k, i32 0, i32 %r4
    %r6 = load i32, ptr %r5
    call void @sub_impl(ptr %r0,ptr %r1,i32 %r6)
    ret void
}
define i32 @main()
{
