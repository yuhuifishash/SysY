...
L3:  ;
    ...
    store float %r170, ptr %r40
    store float %r171, ptr %r41
    store float %r172, ptr %r42
    store float %r173, ptr %r43
    store float %r174, ptr %r44
    store float %r175, ptr %r45
    store float %r176, ptr %r46
    store float %r177, ptr %r47
    store float %r178, ptr %r48
    store float %r179, ptr %r49
    store float %r180, ptr %r50
    store float %r181, ptr %r51
    store float %r182, ptr %r52
    store float %r183, ptr %r53
    store float %r184, ptr %r54
    store float %r185, ptr %r55
    store float %r186, ptr %r56
    store float %r187, ptr %r57
    store float %r188, ptr %r58
    store float %r189, ptr %r59
    store float %r190, ptr %r60
    store float %r191, ptr %r61
    store float %r192, ptr %r62
    store float %r193, ptr %r63
    store float %r194, ptr %r64
    store float %r195, ptr %r65
    store float %r196, ptr %r66
    store float %r197, ptr %r67
    store float %r198, ptr %r68
    store float %r199, ptr %r69
    store float %r200, ptr %r70
    store float %r201, ptr %r71
    store float %r202, ptr %r72
    store float %r203, ptr %r73
    store float %r204, ptr %r74
    store float %r205, ptr %r75
    store float %r206, ptr %r76
    store float %r207, ptr %r77
    store float %r208, ptr %r78
    store float %r213, ptr %r79
    br label %L1
}
...
L3:  ;
    ...
    store i32 %r288, ptr %r64
    store i32 %r289, ptr %r65
    store i32 %r290, ptr %r66
    store float %r291, ptr %r67
    store i32 %r292, ptr %r68
    store i32 %r293, ptr %r69
    store i32 %r294, ptr %r70
    store float %r295, ptr %r71
    store float %r296, ptr %r72
    store float %r297, ptr %r73
    store i32 %r298, ptr %r74
    store float %r299, ptr %r75
    store float %r300, ptr %r76
    store i32 %r301, ptr %r77
    store float %r302, ptr %r78
    store i32 %r303, ptr %r79
    store float %r304, ptr %r80
    store float %r305, ptr %r81
    store float %r306, ptr %r82
    store float %r307, ptr %r83
    store float %r308, ptr %r84
    store float %r309, ptr %r85
    store i32 %r310, ptr %r86
    store float %r311, ptr %r87
    store i32 %r312, ptr %r88
    store i32 %r313, ptr %r89
    store float %r314, ptr %r90
    store float %r315, ptr %r91
    store float %r316, ptr %r92
    store float %r317, ptr %r93
    store float %r318, ptr %r94
    store i32 %r319, ptr %r95
    store float %r320, ptr %r96
    store i32 %r321, ptr %r97
    store float %r322, ptr %r98
    store float %r323, ptr %r99
    store float %r324, ptr %r100
    store float %r325, ptr %r101
    store i32 %r326, ptr %r102
    store i32 %r327, ptr %r103
    store float %r328, ptr %r104
    store float %r329, ptr %r105
    store float %r330, ptr %r106
    store i32 %r331, ptr %r107
    store float %r332, ptr %r108
    store i32 %r333, ptr %r109
    store i32 %r334, ptr %r110
    store float %r335, ptr %r111
    store float %r336, ptr %r112
    store float %r337, ptr %r113
    store float %r338, ptr %r114
    store i32 %r339, ptr %r115
    store i32 %r340, ptr %r116
    store i32 %r341, ptr %r117
    store float %r342, ptr %r118
    store float %r343, ptr %r119
    store float %r344, ptr %r120
    store float %r345, ptr %r121
    store float %r346, ptr %r122
    store float %r347, ptr %r123
    store i32 %r348, ptr %r124
    store float %r349, ptr %r125
    store i32 %r350, ptr %r126
    store float %r351, ptr %r127
    br label %L1
L5:  ;
...
L3:  ;
    ...
    store float %r322, ptr %r64
    store i32 %r324, ptr %r65
    store float %r326, ptr %r66
    store i32 %r327, ptr %r67
    store float %r328, ptr %r68
    store float %r329, ptr %r69
    store i32 %r332, ptr %r70
    store i32 %r333, ptr %r71
    store i32 %r337, ptr %r72
    store float %r340, ptr %r73
    store float %r341, ptr %r74
    store float %r342, ptr %r75
    store i32 %r344, ptr %r76
    store float %r345, ptr %r77
    store float %r346, ptr %r78
    store float %r347, ptr %r79
    store float %r353, ptr %r80
    store float %r354, ptr %r81
    store i32 %r356, ptr %r82
    store float %r359, ptr %r83
    store float %r360, ptr %r84
    store i32 %r363, ptr %r85
    store i32 %r364, ptr %r86
    store float %r365, ptr %r87
    store float %r366, ptr %r88
    store i32 %r368, ptr %r89
    store i32 %r370, ptr %r90
    store float %r373, ptr %r91
    store float %r374, ptr %r92
    store i32 %r376, ptr %r93
    store float %r379, ptr %r94
    store i32 %r380, ptr %r95
    store float %r381, ptr %r96
    store float %r385, ptr %r97
    store i32 %r387, ptr %r98
    br label %L1
L5:  ;
