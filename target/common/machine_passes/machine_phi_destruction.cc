        ...
        while (!copylist.empty()) {
            if(!can_seq.empty()){
                ...
                if(copylist.find(dstreg) != copylist.end()){
                    ...
                    block->insert(insert_it,new MachineCopyInstruction(srcop,new MachineRegister(dstreg),dstreg.type));
                }
            }else{
                ...
                block->insert(insert_it,new MachineComment("Phi Destruction Copy\n"));
                block->insert(insert_it,new MachineCopyInstruction(src_op,new MachineRegister(mid_reg),dst_reg.type));
