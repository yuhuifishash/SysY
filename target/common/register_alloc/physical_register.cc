...
int getIdleReg(const std::vector<int>& range,LiveInterval interval){
	return -1;
}
int getIdleMem(int width,LiveInterval interval){
	return 0;
}

int swapPhysicalReg(int phy_id1,LiveInterval interval1,int phy_id2,LiveInterval interval2){
    return 0;
}
