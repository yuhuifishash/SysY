...
template <> void ArmPrinter::printArm<MachinePhiInstruction *>(MachinePhiInstruction *);
template <> void ArmPrinter::printArm<ArmBaseInstruction *>(ArmBaseInstruction *ins);
...
template <> void ArmPrinter::printArm<ArmBinary *>(ArmBinary *ins) {
    switch (ins->opcode) {
    case ArmBinary::ADD:
        (*this) << "add";
        break;
...
template <> void ArmPrinter::printArm<ArmAddsubImm *>(ArmAddsubImm *ins) {
    switch (ins->opcode) {
...
template <> void ArmPrinter::printArm<ArmParallelAddsub *>(ArmParallelAddsub *ins) {
    assert(false);
    /*
        (*this)<<prefix;
        switch (ins->opcode)
...
template <> void ArmPrinter::printArm<ArmMulas *>(ArmMulas *ins) {
    switch (ins->opcode) {
    case ArmMulas::MUL:
        (*this) << "mul";
        if (ins->SR) {
...
template <> void ArmPrinter::printArm<ArmMove *>(ArmMove *ins) {
    switch (ins->opcode) {
    case ArmMove::MOV:
        (*this) << "mov";
        break;
...
template <> void ArmPrinter::printArm<ArmMovwt *>(ArmMovwt *ins) {
    switch (ins->opcode) {
    case ArmMovwt::MOVW:
        (*this) << "movw";
        break;
...
template <> void ArmPrinter::printArm<ArmShift *>(ArmShift *ins) {
    (*this) << "mov";
    if (ins->S) {
        (*this) << "s";
    }
...
template <> void ArmPrinter::printArm<ArmCmp *>(ArmCmp *ins) {
    switch (ins->opcode) {
    case ArmCmp::CMP:
        (*this) << "cmp";
        break;
...
template <> void ArmPrinter::printArm<ArmBranchLabel *>(ArmBranchLabel *ins) {
    switch (ins->opcode) {
...
template <> void ArmPrinter::printArm<ArmBranchReg *>(ArmBranchReg *ins) {
    switch (ins->opcode) {
...
template <> void ArmPrinter::printArm<ArmBranchLabelreg *>(ArmBranchLabelreg *ins) {
    (*this) << "cb";
    if (ins->N) {
        (*this) << "n";
    }
...
template <> void ArmPrinter::printArm<ArmLoadStore *>(ArmLoadStore *ins) {
    switch (ins->op) {
...
template <> void ArmPrinter::printArm<ArmLoadStoreM *>(ArmLoadStoreM *ins) {
    switch (ins->op) {
...
template <> void ArmPrinter::printArm<ArmPushpop *>(ArmPushpop *ins) {
    switch (ins->opcode) {
...
template <> void ArmPrinter::printArm<VFPVbin *>(VFPVbin *ins) {
    switch (ins->opcode) {
    case VFPVbin::VADD:
        (*this) << "vadd";
        break;
    ...
    (*this) << ins->cond << "." << ins->P << " " << ins->Fd << ", " << ins->Fn << ", " << ins->Fm << " @"
            << ins->comment << "\n";
}

template <> void ArmPrinter::printArm<VFPVcmp *>(VFPVcmp *ins) {
    (*this) << "vcmp";
    if (ins->E) {
        (*this) << "e";
    }
...
template <> void ArmPrinter::printArm<VFPVmov *>(VFPVmov *ins) {
    (*this) << "vmov";
    printCond(s, ins->cond);
...
template <> void ArmPrinter::printArm<VFPVldst *>(VFPVldst *ins) {
...
template <> void ArmPrinter::printArm<VFPVpushpop *>(VFPVpushpop *ins) {
    switch (ins->opcode) {
...
template <> void ArmPrinter::printArm<VFPVstm *>(VFPVstm *ins) {
    switch (ins->opcode) {
    case VFPVstm::VSTM:
...
template <> void ArmPrinter::printArm<MachinePhiInstruction *>(MachinePhiInstruction *ins) {}
