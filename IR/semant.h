...
public:
    ...
    SemantTable(){
        ...
        FunctionTable[getarray] = new __FuncDef(
            Type::INT,getarray,new std::vector<FuncFParam>{new __FuncFParam(Type::INT)},nullptr
        );
        Symbol getfarray = id_table.add_id("getfarray");
        FunctionTable[getfarray] = new __FuncDef(
            Type::INT,getfarray,new std::vector<FuncFParam>{new __FuncFParam(Type::FLOAT)},nullptr
        );
        ...
        FunctionTable[putarray] = new __FuncDef(
            Type::VOID,putarray,new std::vector<FuncFParam>{new __FuncFParam(Type::INT),new __FuncFParam(Type::INT)},nullptr
        );
        Symbol putfarray = id_table.add_id("putfarray");
        FunctionTable[putfarray] = new __FuncDef(
            Type::VOID,putfarray,new std::vector<FuncFParam>{new __FuncFParam(Type::INT),new __FuncFParam(Type::FLOAT)},nullptr
        );
        Symbol putf = id_table.add_id("putf");
        FunctionTable[putf] = new __FuncDef(
            Type::VOID,putf,new std::vector<FuncFParam>{},nullptr
        );
