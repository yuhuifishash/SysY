...
{$$ = new __FuncDef(Type::INT,$2,$4,$6); $$->SetLineNumber(line_number);}
|INT IDENT '(' ')' Block
{$$ = new __FuncDef(Type::INT,$2,new std::vector<FuncFParam>(),$5); $$->SetLineNumber(line_number);}
|FLOAT IDENT '(' FuncFParams ')' Block
{$$ = new __FuncDef(Type::FLOAT,$2,$4,$6); $$->SetLineNumber(line_number);}
|FLOAT IDENT '(' ')' Block
{$$ = new __FuncDef(Type::FLOAT,$2,new std::vector<FuncFParam>(),$5); $$->SetLineNumber(line_number);}
|NONE_TYPE IDENT '(' FuncFParams ')' Block
{$$ = new __FuncDef(Type::VOID,$2,$4,$6); $$->SetLineNumber(line_number);}
|NONE_TYPE IDENT '(' ')' Block
{$$ = new __FuncDef(Type::VOID,$2,new std::vector<FuncFParam>(),$5);$$->SetLineNumber(line_number);}
;
...
ConstInitVal
:ConstExp{$$ = new ConstInitVal_exp($1); $$->SetLineNumber(line_number);}
|'{' ConstInitVal_list '}'{$$ = new ConstInitVal($2); $$->SetLineNumber(line_number);}
|'{' '}'{$$ = new ConstInitVal(new std::vector<InitVal>()); $$->SetLineNumber(line_number);}
;

VarInitVal
:Exp{$$ = new VarInitVal_exp($1); $$->SetLineNumber(line_number);}
|'{' VarInitVal_list '}'{$$ = new VarInitVal($2); $$->SetLineNumber(line_number);}
|'{' '}'{$$ = new VarInitVal(new std::vector<InitVal>()); $$->SetLineNumber(line_number);}
;
...
|FOR '(' VarDecl Cond ';' Lval '=' Exp ')' Stmt {
    $$ = new for_stmt($4,$10,new assign_stmt($6,$8),$3);
    $$->SetLineNumber(line_number);
}
;
...
|Lval{$$ = $1; $$->SetLineNumber(line_number);}
|IntConst{$$ = $1; $$->SetLineNumber(line_number);}
|FloatConst{$$ = $1; $$->SetLineNumber(line_number);}
|StringConst{$$ = $1; $$->SetLineNumber(line_number);}
;
...
AddExp
:MulExp{$$ = $1;$$->SetLineNumber(line_number);}
