...
L3:
    ...
    %r115 = add i32 0,31
    %r116 = getelementptr [32 x [2 x i32]], ptr %r0, i32 0, i32 %r115
    %r117 = call i32 @param32_arr(ptr %r54,ptr %r56,ptr %r58,ptr %r60,ptr %r62,ptr %r64,ptr %r66,ptr %r68,ptr %r70,ptr %r72,ptr %r74,ptr %r76,ptr %r78,ptr %r80,ptr %r82,ptr %r84,ptr %r86,ptr %r88,ptr %r90,ptr %r92,ptr %r94,ptr %r96,ptr %r98,ptr %r100,ptr %r102,ptr %r104,ptr %r106,ptr %r108,ptr %r110,ptr %r112,ptr %r114,ptr %r116)
    call void @putint(i32 %r117)
    %r118 = add i32 0,10
    call void @putch(i32 %r118)
    %r119 = add i32 0,0
    ret i32 %r119
}
