...
.max_sum_nonadjacentL1:
	mvn r8,#75
	add r7,fp,r8
	@call void @memset(i32 %r50,i32 0,i32 64)
...
.longest_common_subseqL1:
	...
	movt r8,#65535  @ -1040
	add r7,fp,r8
	@call void @memset(i32 %r75,i32 0,i32 1024)
	sub sp,sp,#4 @stack align 8bytes
	push {r0,r2}
	mov r0,r7
	mov r1,#0
...
.longest_common_subseqL5:
	...
	ldr r7,[fp,#-1048]
	cmp r8,r7
	ble .longest_common_subseqL6
.longest_common_subseqL7:
	ldr r8,[fp,#-16]
	mov r7,#1
	add r6,r8,r7
	str r6,[fp,#-16]
	bl .longest_common_subseqL2
.longest_common_subseqL6:
	ldr r8,[fp,#-16]
	mov r7,#1
	sub r6,r8,r7
	mov r8,r6
