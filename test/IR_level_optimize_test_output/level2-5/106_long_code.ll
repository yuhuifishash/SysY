...
L5:
    ...
    br i1 %r29, label %L13, label %L9
L7:
    %r74 = phi i32 [0,%L13],[%r57,%L8]
    %r70 = phi i32 [0,%L13],[%r69,%L8]
    %r67 = phi i32 [%r66,%L8],[0,%L13]
...
L3:
    %r46 = phi i32 [0,%L9],[%r48,%L4]
    %r44 = phi i32 [0,%L9],[%r37,%L4]
