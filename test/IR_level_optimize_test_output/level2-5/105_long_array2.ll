...
L0:
    br label %L1
L1:
    %r3 = getelementptr [4096 x i32], ptr @a, i32 0, i32 5
    store i32 4000, ptr %r3
    %r6 = getelementptr [4096 x i32], ptr @a, i32 0, i32 4000
    store i32 3, ptr %r6
    %r9 = getelementptr [4096 x i32], ptr @a, i32 0, i32 4095
    store i32 7, ptr %r9
    %r11 = getelementptr [4096 x i32], ptr @a, i32 0, i32 2216
