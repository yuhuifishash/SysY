...
L1:
    br label %L47
L3:
    %r157 = phi i32 [0,%L47],[%r152,%L4]
    %r149 = phi i32 [0,%L47],[%r114,%L4]
    br label %L48
L4:
...
L5:
    ret i32 %r152
L7:
    %r155 = phi i32 [%r152,%L8],[%r157,%L48]
    %r147 = phi i32 [%r103,%L8],[0,%L48]
    br label %L49
L8:
...
L13:
    ...
    br label %L8
L15:
    %r151 = phi i32 [%r79,%L16],[%r153,%L50]
    %r137 = phi i32 [%r76,%L16],[0,%L50]
    %r32 = add i32 %r137,1
