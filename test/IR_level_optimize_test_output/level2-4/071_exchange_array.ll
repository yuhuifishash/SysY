...
L1:
    ...
    br label %L6
L3:
    %r102 = phi i32 [%r92,%L4],[0,%L6]
    %r71 = getelementptr [5 x [5 x i32]], ptr %r0, i32 0, i32 1, i32 %r102
    %r72 = load i32, ptr %r71
    %r77 = getelementptr [5 x [5 x i32]], ptr %r0, i32 0, i32 2, i32 %r102
    %r78 = load i32, ptr %r77
    store i32 %r78, ptr %r71
    store i32 %r72, ptr %r77
    %r92 = add i32 %r102,1
    br label %L4
L4:
    %r95 = icmp slt i32 %r92,5
    br i1 %r95, label %L3, label %L5
L5:
    %r100 = getelementptr [5 x [5 x i32]], ptr %r0, i32 0, i32 2, i32 0
