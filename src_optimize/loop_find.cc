...
std::set<llvm_block> find_nodes_inloop(CFG* cfg,llvm_block n,llvm_block d) //backedge n->d
{
    std::set<llvm_block> loop_nodes;

    std::stack<llvm_block> S;
